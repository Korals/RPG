    ...
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                {
                    response.Success = false;
                    response.Message = "No such Skill!";
                    return response;
                }
        ...
        {
            int damage = skill.Damage + (new Random().Next(0, attacker.Intelligence));
        ...
        {
            int damage = attacker.Weapon.Damage + (new Random().Next(0, attacker.Strenght));
            damage -= new Random().Next(opponent.Defence);
